(define (problem Ejercicio2-3)
	...
	(:goal
		(and (TieneObjeto diCaprio) (TieneObjeto princesa) (TieneObjeto bruja) (TieneObjeto profesor) (TieneObjeto principe)  (<= (CosteDesplazamiento) 44))
	)
)
