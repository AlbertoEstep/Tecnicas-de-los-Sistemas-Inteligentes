(define (problem Ejercicio7-2)
	...
	(:init
		...
		(PosicionJugador Agente3 z9)
		(OrientacionJugador Norte Agente3)
		(ManoLibre Agente3)
		(MochilaLibre Agente3)
		(= (PuntosJugador Agente3) 0)
	)
	(:goal
